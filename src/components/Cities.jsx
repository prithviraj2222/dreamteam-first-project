...
//       try {
//         await axios.patch(`http://localhost:3000/city/${data.id}`);
//         setSearchVal("");
//       } catch (error) {
//         console.log(error);
//       }
...
//       try {
//         await axios.patch(`http://localhost:3000/cities`, { selectedCities });
//         setSelectedCities([]);
//         setSearchVal("");
//       } catch (error) {
//         console.log(error);
...
//   const search = async () => {
//     try {
//       const result = await axios.get("http://localhost:3000/city/search", {
//         params: {
//           name: searchVal.trim(),
//         },
//       });
...
//                         if (e.target.checked) {
//                           setSelectedCities(
//                             perPageCities.map((city) => city.id)
//                           );
//                         } else {
//                           setSelectedCities([]);
//                         }
...
//                     {findCountry(city.state_id)}
//                   </td>
//                   <td onClick={() => removeCity(city)} className="p-1.5 w-full">
//                     <span className="w-full flex justify-center">
//                       <i className="fa-solid fa-xmark text-red-600 text-xl"></i>
//                     </span>
//                   </td>
